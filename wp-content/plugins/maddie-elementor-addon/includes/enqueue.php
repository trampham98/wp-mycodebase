...
function maddie_addon_enqueue_scripts() {
  ...
  wp_enqueue_style('maddie-elementor-addon-style', plugins_url('assets/css/main.css', __DIR__), false, $css_ver);
  wp_enqueue_script('maddie-elementor-addon-script', plugins_url('assets/js/main.js', __DIR__), array('jquery'), $js_ver, true);
}
